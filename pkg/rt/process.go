...
func processAggregated(resp realtimeResponse, serviceID, serviceName, serviceVersion string, m *prom.Metrics) {
	for _, d := range resp.Data {
		processDatacenter("all", serviceID, serviceName, serviceVersion, d.Aggregated, m)
	}
}

func processDatacenter(datacenter, serviceID, serviceName, serviceVersion string, stats datacenter, m *prom.Metrics) {
